...
#head {
	      width: 100%;
    margin: auto;
    background-image: linear-gradient(rgb(65, 77, 171), rgb(61, 86, 174));
    height: 50px;
    -webkit-box-sizing: content-box;
...
Dükkan Girişi  </h124  ></div>
 ...
 <p><strong>Üye girişi</strong></p>
     ...
     <input type="submit" name="Send" id="Send" value="Giriş Yap" />          </form>
                 ...
                 <br />
<p align="center"><h14>Şifremi unuttum</h14><p> <div class="girisbuton2" id="girisbuton2"><i class="fa fa-facebook-square" aria-hidden="true"></i>
