...
<title>Şifremi unuttum - Tadilat</title>
</head>
<style>
h61{
   ...
   <div class="giris" id="giris">
    <div class="girisic" id="girisic">
      <div class="baslik" id="baslik">
       <p><strong>Şifremi unuttum</strong></p>

                

      </div>
      <br />
       <font style="font-size:13px"<p>Kayıtlı e-posta adresinizi ilgili alana girerek şifrenizi e-posta adresinize gönderebilirsiniz.
        ...
        <form id="form" name="form" method="post" action="profile.php">
          ...
          <input type="password" name="pass"  placeholder="Mail adresinizi girin" id="pass" />


     <input type="submit" name="Send" id="Send" value="Gönder" />          </form>
 
                 <br />
<p align="right"><h14>
  <div class="sifremi" id="sifremi"></div>
</h14><p> 
 

<div class="girisbuton3" id="girisbuton3"><i class="fa fa-facebook-square" aria-hidden="true"></i>
 Facebook ile Bağlan</div></div>
