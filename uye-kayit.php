...
<link rel="stylesheet" href="css/font-awesome.min.css">
 ...
 <meta name="theme-color" content="#3b80c7">
...
#girisbuton {
	background: rgb(16, 158, 14);
    color: white;
    max-width: 334px;
    border-radius: 3px;
	border-top: 2px solid #26b924;
    margin: auto;
    margin-top: 20px;
    text-indent: 0;
    padding: 7px;
    text-align: center;
    border-bottom: 3px solid #108a0e;
}
#girisbuton1 {
	    background: rgb(14, 64, 158);
    color: white;
    max-width: 334px;
    border-radius: 3px;
    margin: auto;
	    border-top:   3px solid #134cb7;
    margin-top: 20px;
    text-indent: 0;
    padding: 7px;
    text-align: center;
    border-bottom: 3px solid #0b2f73;
}
#girisbuton2 {
       color: white;
    max-width: 218px;
...
<div class="ust" id="ust">
  <div class="head" id="head">
    <div class="headicc" id="headicc">
      ...
      <h123> <a href="uye-kayit.php"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Kayıt ol</a></h123> <h124  onclick="location.href = '#2';" >  <i   class="fa fa-briefcase" aria-hidden="true"  ></i >
Dükkan Girişi  </h124  ></div>
  ...
  <div class="ne" id="ne" >
    <div class="giris" id="giris">
      <div class="girisic" id="girisic">
        <div class="baslik" id="baslik">
          <p><strong>Üye kayıt</strong></p>
        </div>
        <p>&nbsp;</p>
        
        <form id="form" name="form" method="post" action="boya-badana.php">
          <label for="textfield"></label>
        <input type="email" name="user" id="user" placeholder="E-posta" />
                    <input type="password" name="pass"  placeholder="Şifre" id="pass" /><br />
            <input type="password" name="pass"  placeholder="Şifre Tekrar" id="pass" /><br />

                <input type="text" name="user" id="user" placeholder="Ad/Soyad" />
 <input placeholder="Doğum Tarihi" class="textbox-n" type="text" onfocus="(this.type='date')"  id="date">


<br />

<div class="select12" id="select12">
    <input name="123" type="checkbox" value="" /> 
    <h56><red>
      <u onclick="MM_openBrWindow('kullanici-sozlesmesi.html','KullanıcıSözleşmesi','status=yes,width=500,height=500')"><a href="#">Kullanıcı Sözleşmesini</a></u> ve <u onclick="MM_openBrWindow('gizlilik-politikasi.html','','status=yes,width=500,height=500')"><a href="#">Gizlilik Politikasını</a></u> okudum, kabul ediyorum.</h56>
  </div>
   
    <div class="select12" id="select12">
    <input name="123" type="checkbox" value="" /> 
    <h56>Kampanyalar, indirimler ve haberler ile ilgili e-posta almak istiyorum.</h56>
  </div>

     <input type="submit" name="Send" id="Send" value="Giriş Yap" />          </form>
 
                 <br />
<p align="center" onclick="location.href='http://google.com'"><h14>Zaten üyeyim</h14><p> <div class="girisbuton2" id="girisbuton2"><i class="fa fa-facebook-square" aria-hidden="true"></i>
 Facebook ile Üye Ol</div></div>
    </div>
  </div>
  <br />
...
<div class="mobilfooter" id="mobilfooter">
  <div class="mobilsol" id="mobilsol"><strong>Tadilat</strong>Sepeti</div>
  <div class="mobilsag" id="mobilsag"><a href="uye-kayit.php">Kaydol</a>
    <h513>|</h513> 
  <a href="uye-girisi.php">Giriş yap</a></div>
